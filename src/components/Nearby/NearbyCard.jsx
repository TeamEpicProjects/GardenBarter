              ...
              <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <div class="container-fluid">
                        <div class="row">
                          ...
                          <div class="col-md-8">
                            <input class="form-control" type="text" placeholder="Default input" value={item} aria-label="default input example" />

                          </div>
                        </div>
                        <div class="row mt-3">
                          <div class="col-md-4"><h6>Quantity in Possession</h6></div>
                          <div class="col-md-8"><input class="form-control" type="text" placeholder="1-50Kg" value={quantity} aria-label="default input example" /></div>
                        </div>
                            ...
                            <div class="dropdown mt-0">
                              <select class="btn btn-secondary dropdown-toggle" name="products" id="dropdownMenuButton">
                                ...
                                {myProducts.map((eachProduct) => (
                                  <option key={eachProduct.id} value="potatoes">{eachProduct.item}</option>
                                ))}
                              </select>
                        ...
                        <div class="row mt-3">
                          ...
                          <div class="col-md-8"><input class="form-control" type="text" placeholder="5-100Kg" aria-label="default input example" /></div>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="modal-footer">
                    <button type="button" class="btn btn-primary-center mx-auto text-white">Send Request</button>
                  </div>
                </div>
              </div>
            </div>
